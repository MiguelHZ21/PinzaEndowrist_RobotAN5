...
public class recordPanel : MonoBehaviour
{
    ...
    private void GuardarPunto(float[] cartesianPositions)
    {
        ...
        grabarDisplay.text += $"P {pointIndex - 1}: " +
                              ...
                              $", Pinza: [{endoWristPositions[0]:F2}, {endoWristPositions[1]:F2}, {endoWristPositions[2]:F2}, {endoWristPositions[3]:F2}]";
        ...
        endoWristPositions.CopyTo(lastEndoWristPositions, 0);

        // Guardar la posición cartesiana actual en la lista
        cartesianPositionsList.Add((float[])cartesianPositions.Clone());
        endoWristPositionsList.Add((float[])endoWristPositions.Clone());
