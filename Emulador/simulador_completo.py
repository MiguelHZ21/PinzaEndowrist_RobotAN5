...
class RobotEndowristSyncNode(Node):
    def __init__(self):
        ...
        ur5_file = os.path.join(script_dir, 'posiciones_articulares_ur5_der_20260907_202245.txt')
        psm_file = os.path.join(script_dir, 'posiciones_articulares_psm_der_20260907_202245.txt')
